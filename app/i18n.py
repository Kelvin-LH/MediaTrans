...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "parallel_tip": "Convert files in parallel (auto-scaled to CPU cores)",
        "gpu_tip": "GPU-accelerated video encoding (NVENC / QSV / AMF / VideoToolbox)",
    ...
    "zh": {
        ...
        "parallel_tip": "并行转换多个文件（按 CPU 核数自动调度）",
        "gpu_tip": "GPU 硬件加速视频编码（NVENC / QSV / AMF / VideoToolbox）",
